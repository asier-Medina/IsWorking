...
export default function Historial() {
    ...
    const navLinks = [
        { label: 'Fichar',       href: '/dashboard', icon: 'https://img.icons8.com/ios/48/3e35a8/time-card.png' },
        { label: 'Mis fichajes', href: '/historial',  icon: 'https://img.icons8.com/ios/48/3e35a8/planner.png' },
    ]
    ...
    useEffect(() => {
        const getRecords = async () => {
            try {
                setLoading(true);
                const response = await api.get("/records/me");
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <main className="app-main">
                {loading && <div className="record__loading">Cargando historial...</div>}
                {error   && <div className="record__error" role="alert">{error}</div>}
